...
-- Window Manipulation
vim.keymap.set({ "n", "v" }, "<leader>vs", "<cmd>vsplit<CR>", { remap = true }) -- Open vertical split window
vim.keymap.set({ "n", "v" }, "<leader>hs", "<cmd>split<CR>", { remap = true }) -- Open horizontal split window
...
vim.keymap.set({ "n", "v" }, "<C-Up>", "<cmd>resize -1<CR>", { silent = true }) -- Resize window up
vim.keymap.set({ "n", "v" }, "<C-Down>", "<cmd>resize +1<CR>", { silent = true }) -- Resize window down
vim.keymap.set({ "n", "v" }, "<C-Left>", "<cmd>vertical resize -1<CR>", { silent = true }) -- Resize window left
vim.keymap.set({ "n", "v" }, "<C-Right>", "<cmd>vertical resize +1<CR>", { silent = true }) -- Resize window right
